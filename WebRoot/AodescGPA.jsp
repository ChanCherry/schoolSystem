...
String sql="select * from Stu where 专业=N'"+special+"' order by GPA desc";
...
<body>
<h2><%=special%>专业学生GPA降序排序</h2><br>
<table width="600" border="1">
<tr bgcolor="#BBFFFF"><td><center>学号</center></td>
<td><center>姓名</center></td><td><center>性别</center></td><td><center>出生年月</center></td><td><center>专业</center></td>
...
%>
<br><br><button name="back" style="width:100px;height:30px" onclick="window.location.href='adminInfo.jsp'">返回</button>
<%
}
else{
	out.print("<script>alert('排序失败！学校暂时不存在"+special+"专业！')</script>");
