...
<body>
<div id="aa">
	<form action="StuLogin_servlet" method="post">
		<div class="log">
			<!-- 头部提示信息 -->
			<div class="lgA">
				<p class="p1">学生登录/注册</p>
			</div>
			...
			<div class="lgB">
				密码：<input type="password" name="spwd" placeholder="输入登录密码" />
			</div>
			<div class="lgC">
				<input type="submit" name="login" value="登    录">
			</div>
			<div class="lgD">
				<input type="submit" formaction="stuReg.jsp" name="register" value="注    册">
			</div>
		</div>
	</form>
</div>
