...
public class moStuSelect3_servlet extends HttpServlet{
	protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{ 
		...
		int flag=0;
		out.println("<h2>查询三个字名字以“"+last3+"”字结尾的学生信息如下表：</h2>");
		out.print("<table width='600' border='1' cellspacing='0'><tr bgcolor='#BBFFFF'><td><center>学号</center></td><td><center>姓名</center></td>" +
				...
				"<center><td><center>7班级</center></td><td><center>导师</center></td><td><center>GPA</center></td></tr>");
		try {
			while(rs.next()){
				flag=1;
			...
			if(flag==1){
				...
				out.println("<script>alert('查询失败！不存在三个字名字以“"+last3+"”字结尾的学生！')</script>");
