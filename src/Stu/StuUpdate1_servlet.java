...
public class StuUpdate1_servlet extends HttpServlet{
	protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{ 
		...
		if(flag>0){
			...
			out.println("<script>window.location.href='teaInfo.jsp'</script>");
		}
		else{
			out.println("<script>alert('修改失败！即将返回教师中心页面！')</script>");
			out.println("<script>window.location.href='teaInfo.jsp'</script>");
		}
		StuUpdate.close();
	}
