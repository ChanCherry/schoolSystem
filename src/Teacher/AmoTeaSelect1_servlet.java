...
public class AmoTeaSelect1_servlet extends HttpServlet{
	protected void doPost(HttpServletRequest req,HttpServletResponse resp) throws ServletException, IOException{ 
		...
		String queryString="select * from Teacher where 姓名 like N'%"+xing+"_%'";
		ResultSet rs=query.executeQuery(queryString);
		int flag=0;
		out.println("<h2>查询姓“"+xing+"”的教师信息如下表：</h2>");
		...
		try {
			...
			if(flag==1){
				...
				out.println("<script>alert('查询失败！列表里不存在姓“"+xing+"”的教师！')</script>");
